...
function renderLegal(kind: 'privacy' | 'terms'): void {
  ...
  const privacy = `<main id="main" class="legal" tabindex="-1"><p class="eyebrow">Privacy notice · effective 30 August 2026</p><h1>Privacy, kept local</h1>
    ...
    <h2>What leaves your device</h2><p>Nothing during ordinary cover generation. Buying opens Sociobot’s hosted Dodo checkout. Dodo is the merchant of record and handles order inquiries and returns. License verification sends the token to the Sociobot billing API. We run no behavioral analytics or advertising trackers.</p>
  ...
  const terms = `<main id="main" class="legal" tabindex="-1"><p class="eyebrow">Terms notice · effective 30 August 2026</p><h1>Terms of use</h1>
    ...
    <h2>One-time unlock</h2><p>The ${esc(LICENSE_PRICE)} one-time purchase unlocks unlimited package generation and saved client suggestions for this product. Buying opens Sociobot’s hosted Dodo checkout. Dodo is the merchant of record and handles order inquiries and returns. A refunded or revoked purchase deactivates its license. You can restore an active license on another device.</p>
